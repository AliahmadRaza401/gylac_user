  ...
  getUpdate() async {
    ...
    if (trackStatus == "WaitForPickup") {
      ...
      Fluttertoast.showToast(
          msg: "Order Delivered Successfully".tr,
                    ...
                    Column(
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              color:
                                  step4 == false ? Colors.grey : Colors.green),
                        ),
                      ],
                    ),
                    Text(
                      "Waiting for Pickup".tr,
                      style: TextStyle(
                          fontSize: 15,
                          fontFamily: 'Poppins',
                          fontWeight: FontWeight.bold,
